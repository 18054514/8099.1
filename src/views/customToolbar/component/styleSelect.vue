      ...
      <el-tab-pane label="pattern">
        <el-form :inline="true" :model="form" class="style-form" size="mini" label-position="left">
          ...
          <el-row>
            ...
            <el-form-item v-if="isNode" label="Fill color">
              <el-color-picker
            ...
            <el-form-item>
              <el-checkbox v-model="form.shadow" @change="$emit('changeShadow', form.shadow)">shadow</el-checkbox>
            </el-form-item>
          </el-row>
          ...
          <el-form-item label="Line style" v-if="!isNode">
            <el-select
          ...
          <el-form-item v-if="isNode" label="Configuration serial number (reserved)">
            <el-input-number
...
<!--          <el-form-item v-if="isNode&&!form.orderPoint" label="Node picture">-->
<!--            <el-select-->
...
<!--          </el-form-item>-->
      ...
      <el-tab-pane label="text">
        <el-form :inline="true" :model="form" class="style-form" size="mini" label-position="left">
          ...
          <el-row>
            <el-form-item>
              <el-checkbox v-model="fontIsBold">overbold</el-checkbox>
            </el-form-item>
            <el-form-item>
              <el-checkbox v-model="fontIsIncline">tilt</el-checkbox>
            </el-form-item>
            <el-form-item>
              <el-checkbox v-model="fontIsUnderline">underline</el-checkbox>
            </el-form-item>
            <el-form-item>
              <el-checkbox v-model="fontIsStrickout">Strikeout line</el-checkbox>
            </el-form-item>
          </el-row>
          ...
          <el-form-item label="Text field background color">
            <el-color-picker
              show-alpha
              :predefine="predefineColors"
...
export default {
  ...
  data () {
    return {
      edgeOptions: [
        { label: "Straight line", value: 'SideToSide' },
        { label: 'Broken line', value: "orthogonalEdgeStyle" }
      ],
      form: {
        edgeStyle: "折线",
        dashed: "0",
